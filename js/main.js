...
(() => {
    ...
    tabsContainer.addEventListener("click", (event) => {
        // if target contains tab-contant class and not contains active class
...
(() => {
    ...
    function popupDetailsToggle(){
        ...
        const details = portfolioItems[itemIndex].querySelector(".portfolio-item-details").innerHTML = details;
